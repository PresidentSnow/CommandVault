INFO: https://www.gnu.org/software/gawk/manual/html_node/String-Functions.html
ORIGINAL TIME: 2025/06/23

- Numeric functions:

    * "atan2(y, x)": this function has two arguments. Return the arctangent of 'y / x' in radians.
    EXAMPLE: 'pi = atan2(0, -1)' to retrieve the value of pi.
...
- Time functions:
INFO: https://www.gnu.org/software/gawk/manual/html_node/Time-Functions.html
...
- String functions:
    ...
    * "gsub()": search 'target', leftmost, 'nonoverlapping' matching substrings it can find and replace them with 'replacement'. The 'g' in 'gsub()' stands for 'global', which means replace everywhere.
    EXAMPLE: {gsub (/Britain/, "United Kingdom"; print)}
...
- Bitwise functions:
INFO: https://www.gnu.org/software/gawk/manual/html_node/Bitwise-Functions.html
...
- I/O functions:
INFO: https://www.gnu.org/software/gawk/manual/html_node/I_002fO-Functions.html
...
- Other functions:
    ...
    * "mkbool": this function is specific to gawk. It's not compatibility...
